  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter+Display:wght@600;700;800&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap"
          rel="stylesheet"
        />
        <HeadContent />
      </head>
